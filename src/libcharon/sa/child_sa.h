...
struct child_sa_t {
	 ...
	 * @param cpu			CPU ID
	 */
	void (*set_cpu)(child_sa_t *this, uint32_t cpu);

	/**
	 * Get number of per-CPU SAs for this CHILD_SA (or its head CHILD_SA).
	 *
	...
	/**
	 * Set number of per-CPU SAs for this CHILD_SA (or its head CHILD_SA).
	 *
